...
class ServiceViewSetTest(APITestCase):
    def setUp(self):
        ...
        self.service1 = Service.objects.create(name='Service 1', bio='Bio 1',
                                               specialization=self.specialization,
                                               logo='logo.jpg')
        self.service2 = Service.objects.create(name='Service 2', bio='Bio 2',
                                               specialization=self.specialization,
                                               logo='logo.jpg')
    ...
    def test_create_service(self):
        url = reverse('service-list')
        data = {'name': 'New Service', 'specialization': self.specialization.id,
                'bio': 'New Bio', 'logo': 'logo.jpg'}
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + self.token.key)
    ...
    def test_update_service(self):
        ...
        updated_data = {'name': 'Updated Service', 'bio': 'Updated Bio',
